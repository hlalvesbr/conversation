...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    ...
    <p class="lead">Search for Conversations</p>
</div>
...
<div class="container">
    <form path="form" method="post">
        <div class="d-flex flex-row align-items-baseline">
            ...
            &nbsp;&nbsp;
            <form:input id="startDateInput" path="form.startDate" class="form-control" placeholder="Start Date"/>
            &nbsp;&nbsp;

            <label for="endDateInput">End&nbsp;Date</label>
            &nbsp;&nbsp;
            <form:input id="endDateInput" path="form.endDate" class="form-control" placeholder="End Date"/>
            &nbsp;&nbsp;
        ...
        <div>
            <table class="table">
                ...
                <tbody>
                <c:forEach items="${form.conversations}" var="conversation">
                    <tr>
                        <th scope="row"><a href="/messages?conv_id=${conversation.id}">${conversation.id}</a></th>
                        <td>${conversation.user_identifier}</td>
                        <td>${conversation.created_at}</td>
                        <td>${conversation.user_ip}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
